...
async function main() {
  ...
  colorLog('yellow', 'This script will help you set up your admin account for the wedding website.');
  ...
  try {
    ...
    const secretsCommands = generateWranglerSecretsCommands(adminEmail, passwordHash);
    ...
    try {
      ...
      colorLog('yellow', `⚠️  Could not write ${commandsPath}. Here are the commands:`);
      console.log('');
