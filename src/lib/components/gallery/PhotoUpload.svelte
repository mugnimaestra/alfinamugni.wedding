...
{#if isOpen}
	<div class="fixed inset-0 z-50 flex items-center justify-center p-4">
		...
		<div
			class="relative z-10 max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-wedding-beige bg-white p-6 shadow-2xl"
		>
			...
			<div class="space-y-4">
				<div>
					...
					>
						...
						<span class="mt-2 text-sm text-wedding-text-muted">Click to select photos</span>
						<input
							type="file"
							accept="image/*"
							multiple
