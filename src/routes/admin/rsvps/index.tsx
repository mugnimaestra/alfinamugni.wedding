      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card class="p-6">
          <div class="flex items-center justify-between">
            ...
            <LuUsers class="w-8 h-8 text-wedding-brown" />
          </div>
        </Card>
        ...
        <Card class="p-6">
          <div class="flex items-center justify-between">
            ...
            <LuCheckCircle class="w-8 h-8 text-green-600" />
          </div>
        </Card>
        ...
        <Card class="p-6">
          <div class="flex items-center justify-between">
            ...
            <LuCalendar class="w-8 h-8 text-blue-600" />
          </div>
        </Card>
        ...
        <Card class="p-6">
          <div class="flex items-center justify-between">
            ...
            <LuXCircle class="w-8 h-8 text-red-600" />
          </div>
        </Card>
      </div>
                    ...
                    <tr key={rsvp.id || index} class="hover:bg-gray-50 transition-colors">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div class="flex flex-col">
                          <div class="flex items-center">
                            <LuMail class="w-3 h-3 mr-1 text-gray-400" />
                            <span>{rsvp.email}</span>
                          </div>
                          {rsvp.phone && (
                            <div class="flex items-center mt-1">
                              <LuPhone class="w-3 h-3 mr-1 text-gray-400" />
